...
data class DiscoModel (
    ...
    override fun toString(): String {
        return "DiscoModel(id='$id', name='$name', bannerID='$bannerID', bannerRef='$bannerRef', bannerCardID='$bannerCardID', email='$email', eventsID=$eventsID, eventsRef='$eventsRef', products=$products, sales=$sales, bannerURL=$bannerURL)"
    }
}