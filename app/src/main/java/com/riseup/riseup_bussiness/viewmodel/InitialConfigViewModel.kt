...
class InitialConfigViewModel:ViewModel() {
    ...
    fun updateDiscoName(user: Disco){
    ...
    fun updateDiscoListImg(user: Disco) {
        viewModelScope.launch(Dispatchers.IO) {
    ...
    fun updateDiscoHomeImg( user: Disco) {
        viewModelScope.launch(Dispatchers.IO) {
    ...
    fun updateDiscoProducts(discoProducts:ArrayList<ProductModel>,user: Disco){
        viewModelScope.launch(Dispatchers.IO) {
